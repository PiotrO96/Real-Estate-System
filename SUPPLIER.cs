    ...
    public partial class SUPPLIER : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb = "insert into Account(ACCOUNTID,ACCOUNTNAME,ADDRESS,PHONE,EMAIL,EXTRA,EXTRA1,ACCOUNTGROUPID,ACCOUNTGROUPNAME,OPBAL,DC) VALUES (" + txtSupplierid.Text + ",'" + txtSupplierName.Text + "','" + txtAddress.Text + "','" + txtPhoneNo.Text + "','" + txtEmail.Text + "','" + txt_extra1.Text + "','" + txt_extradetail1.Text + "'," + "33" + ",'" + "SUPPLIERS" + "'," + txtOpbal.Text + ",'" + cmbcrdr.Text + "')";
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update Account set ACCOUNTNAME = '" + txtSupplierName.Text + "',ADDRESS= '" + txtAddress.Text + "',PHONENO= '" + txtPhoneNo.Text + "',EMAIL= '" + txtEmail.Text + "',EMAIL= '" + txtEmail.Text + "',DC= " + cmbcrdr.Text + ",EXTRADETAIL= '" + txt_extra1.Text + "',EXTRADETAIL1= '" + txt_extradetail1.Text + "' where ACCOUNTID= " + txtSupplierid.Text + "";
                cmd = new OleDbCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
