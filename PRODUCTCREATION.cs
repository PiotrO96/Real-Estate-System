...
namespace ACCOUNTMANAGEMENT
{
   ...
   //     Purchase ths;
  //      SALESINVOICEcs ths1;
        public PRODUCTCREATION()//(Purchase frm)//,SALESINVOICEcs frm1)
        {
            ...
            //ths1 = frm1;
            //lblpath.Text = ths1.lblpath.Text;
        }
        ...
        //public PRODUCTCREATION(Purchase purchase)
        //{
        //    // TODO: Complete member initialization
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    if (rdr.IsDBNull(rdr.GetOrdinal("ITEMID")))
                    {
                        ...
                        lblitemid.Text = Convert.ToString("1");
                    }
                    else
                    {
                        lblitemid.Text = Convert.ToString(Convert.ToInt16(rdr["ITEMID"]) + 1);
                    }
                }
                if ((rdr != null))
                {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "SELECT VOUCHERTYPE  as  VOUCHERTYPE FROM INVENTORY WHERE  ITEMID=" + lblitemid.Text + " ";
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    ...
                    else
                    {
                        ...
                        else 
                        {
                            con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                            con.Open();
                            string cb = "DELETE FROM INVENTORY WHERE ITEMID = " + lblitemid.Text + "";
                            cmd = new OleDbCommand(cb);
                            cmd.Connection = con;
                            cmd.ExecuteReader();
                            con.Close();
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb1 = "DELETE FROM ItemMaster WHERE ITEMID = " + lblitemid.Text + "";
                cmd = new OleDbCommand(cb1);
                cmd.Connection = con;
                cmd.ExecuteReader();
                con.Close();
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            if (fc != null)
            {
                purchase.lblchange.Text = "0";
            //    purchase.lblpath.Text = lblpath.Text;    
            //    purchase.itemresete();
            //    purchase.cmbitemname.Focus();
            }
            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    ...
                    if (rdr.Read())
                    {
                        ...
                        {
                            lblgroupid.Text = Convert.ToString(Convert.ToInt16(rdr["GROUPID"]));
                        }
                    }
                    if ((rdr != null))
                    {
            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    ...
                    if (rdr.Read())
                    {
                        ...
                        {
                         lblcompanyid.Text = Convert.ToString(Convert.ToInt16(rdr["PRODUCTCOMPANYID"]));
                        }
                    }
                    if ((rdr != null))
                    {
            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    ...
                    if (rdr.Read())
                    {
                        ...
                        {
                           lbltaxid.Text = Convert.ToString(Convert.ToInt16(rdr["TAXID"]));
                        }
                    }
                    if ((rdr != null))
                    {
            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    ...
                    if (rdr.Read())
                    {
                        ...
                        {
                          lbUnit.Text = Convert.ToString(Convert.ToInt16(rdr["UNITID"]));
                        }
                    }
                    if ((rdr != null))
                    {
            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    ...
                    if (rdr.Read())
                    {
                        ...
                        {
                         lblaltunit.Text = Convert.ToString(Convert.ToInt16(rdr["UNITID"]));
                        }
                    }
                    if ((rdr != null))
                    {
        ...
        private void dgwItem_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
               ...
               if (rdr.Read())
               {
                   ...
                   {
                       lblitemid.Text = Convert.ToString(rdr["ITEMID"]); 
                   txtItemName.Text = Convert.ToString(rdr["ITEMNAME"]);
                    lblgroupid.Text = Convert.ToString(rdr["GROUPID"]);
                    cmbGroup.Text = Convert.ToString(rdr["GROUPNAME"]);
                   lblcompanyid.Text = Convert.ToString(rdr["PRODUCTCOMPANYID"]);
                   cmbCompany.Text = Convert.ToString(rdr["PRODUCTCOMPANYNAME"]);
                     lbUnit.Text = Convert.ToString(rdr["UNITID"]);
                      cmbUnit.Text = Convert.ToString(rdr["UNITNAME"]);
                     lbltaxid.Text = Convert.ToString(rdr["TAXID"]);
                  ...
                  txtMinimumQty.Text = Convert.ToString(rdr["MINIMUMQTY"]);
                    lblaltunit.Text = Convert.ToString(rdr["ALTUNITID"]);
