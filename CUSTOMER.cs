    ...
    public partial class CUSTOMER : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb = "insert into Customer(CUSTOMERNAME,ADDRESS,PHONENO,MOBILENO,EMAIL,EXTRADETAIL,EXTRADETAIL1) VALUES ('" + txtCustomerName.Text + "','" + txtAddress.Text + "','" + txtPhoneNo.Text + "','" + txt_Mobile.Text + "','" +txtEmail.Text +"','" + txt_extra1.Text + "','" + txt_extradetail1.Text + "')";
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update Customer set CUSTOMERNAME = '" + txtCustomerName.Text + "',ADDRESS= '" + txtAddress.Text + "',PHONENO= '" + txtPhoneNo.Text + "',EMAIL= '" + txtEmail.Text + "',MOBILENO= '" + txt_Mobile.Text + "',EXTRADETAIL= '" + txt_extra1.Text + "',EXTRADETAIL1= '" + txt_extradetail1.Text + "' where CUSTOMERID= '" + txtcustid.Text + "'";
                cmd = new OleDbCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
