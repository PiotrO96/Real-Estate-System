            ...
            if (e.KeyData == Keys.Enter)
            {
                try
                {
                    if (cmbEmployeeName.Text != null)
                    {
                        ...
                        while (rdr.Read())
                        {
                            lblEmployeeid.Text = (rdr["ACCOUNTID"].ToString());
