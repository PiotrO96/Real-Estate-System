    ...
    public partial class LEDGERAM : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = con.CreateCommand();
                cmd.CommandText = "SELECT LedgerPosting.LEDGERPOSTINGID FROM LedgerPosting where ACCOUNTID=" + lblcustid.Text + " ";
                rdr = cmd.ExecuteReader();
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                String sql1 = "SELECT LDATE,VOUCHERTYPE,VOCHERNO,DEBIT,CREDIT,EXTRA FROM LedgerPosting where LedgerPosting.ACCOUNTID=" + lblcustid.Text + "";
