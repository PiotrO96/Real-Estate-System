...
namespace ACCOUNTMANAGEMENT
{
    public partial class COMPANY : Form
    {
        ...
        String cs = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\\ACCOUNTMANAGEMENT\\Data\\accountmanagement.accdb;";
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.IO.Directory.CreateDirectory(@"D:\\ACCOUNTMANAGEMENT\\Data" + "\\" + txtCompanyName.Text);
                System.IO.File.Copy(@"D:\\ACCOUNTMANAGEMENT\\Data\\accountmanagement.accdb", @"D:\\ACCOUNTMANAGEMENT\\Data" + "\\" + txtCompanyName.Text + "\\accountmanagement.accdb");

                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\\ACCOUNTMANAGEMENT\\Data" + "\\" + txtCompanyName.Text + "\\accountmanagement.accdb;");
                con.Open();
                ...
                con = new OleDbConnection(cs);
                con.Open();
                string PATH = @"D:\\ACCOUNTMANAGEMENT\\Data" + "\\" + txtCompanyName.Text + "\\accountmanagement.accdb";
