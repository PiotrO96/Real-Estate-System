    ...
    public partial class UNIT : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb = "insert into Unit(UNITID,UNITNAME) VALUES (" + lblUnitId.Text + ",'" + txtUnit.Text + "')";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update Unit set  UNITNAME = '" + txtUnit.Text + "' where  UNITID = " + lblUnitId.Text + "";
                cmd = new OleDbCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb = "DELETE UNITNAME FROM Unit WHERE UNITID=" + lblUnitId.Text + "";
                cmd = new OleDbCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
                con.Close();
        ...
        private void dgwUnit_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                lblUnitId.Text = dgwUnit.SelectedRows[0].Cells[0].Value.ToString();
