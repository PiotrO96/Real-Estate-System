    ...
    public partial class PLOTSELL : Form
    {
        ...
        public void Reset()
        {
            try
            {
                ...
                if (rdr.Read())
                {
                    if (rdr.IsDBNull(rdr.GetOrdinal("PLOTSELLID")))
                    {
                        lblplotsell.Text = Convert.ToString("1");
                    }
                    else
                    {
                        lblplotsell.Text = Convert.ToString(Convert.ToInt16(rdr["PLOTSELLID"]) + 1);
                    }
                }
                if ((rdr != null))
                {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if(txtinstallment.Text!="")
            {
                ...
                if (txttotalinstallmentamount.Text == txtbalanceamount.Text)
                {
                    ...
                    con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                    con.Open();
                    string cb = "insert into Installment(INSTALLMENTNO,INSTALLMENTDATE,INSTALLMENT,PLOTSELLID,CUSTOMERID,PAIDSTATUS) VALUES (" + txtinstallmentno.Text + ",'" + dtpInvoiceDate.Text + "'," + txtinstallment.Text + "," + lblplotsell.Text + "," + lblcustid.Text + ",'" + x + "')";
                    ...
                    con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                    con.Open();
                    String sql = "SELECT INSTALLMENTNO,INSTALLMENTDATE,INSTALLMENT FROM Installment WHERE PLOTSELLID=" + lblplotsell.Text + "";
                    cmd = new OleDbCommand(sql, con);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb1 = "insert into Ledger(PLOTSELLID,VOUCHERDATE,VOUCHERTYPE,VOUCHERNO,DEBIT,BAL) VALUES (" + lblplotsell.Text + ",'" + dtpDate.Text + "','" + "TOTAL PLOT SELL AMOUNT" + "'," + lblplotsell.Text + "," + txttotalamount.Text + "," + txttotalamount.Text + ")";
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb2 = "insert into Ledger(PLOTSELLID,VOUCHERDATE,VOUCHERTYPE,VOUCHERNO,CREDIT,BAL) VALUES (" + lblplotsell.Text + ",'" + dtpDate.Text + "','" + "Booking AMOUNT" + "'," + lblplotsell.Text + "," + txtbookingamout.Text + "," + a.ToString() + ")";
                ...
                con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source='" + lblpath.Text + "';");
                con.Open();
                string cb3 = "insert into Ledger(PLOTSELLID,VOUCHERDATE,VOUCHERTYPE,VOUCHERNO,CREDIT,BAL) VALUES (" + lblplotsell.Text + ",'" + dtpDate.Text + "','" + "AGREEMENT AMOUNT" + "'," + lblplotsell.Text + "," + txtagreementamount.Text + "," + a.ToString() + ")";
                ...
                con.Close();
                    ...
                    if (result1 == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            cmd.CommandText = "SELECT Installment.INSTALLMENTNO,Installment.INSTALLMENTDATE,Installment.INSTALLMENT FROM Installment WHERE  Installment.PLOTSELLID =" + lblplotsell.Text + " ";
                            cmd.CommandType = CommandType.Text;
                            myDA.SelectCommand = cmd;
